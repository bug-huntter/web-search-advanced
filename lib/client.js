...
function WebSearchAdvancedSection(props) {
	...
	if (state.status !== "ready") return React.createElement("div", { style: st.section }, React.createElement("p", { style: st.hint }, state.status === "loading" ? "Loading…" : "Unavailable"));
	...
	return React.createElement("div", { style: st.section }, React.createElement("h2", { style: st.heading }, t("title")), React.createElement("p", { style: st.intro }, t("description")), React.createElement("div", { style: st.field }, React.createElement("span", { style: st.label }, t("card.provider")), React.createElement("div", {
		style: st.choices,
		role: "radiogroup",
	...
	})), React.createElement("p", { style: st.hint }, t("card.providerHint"))), React.createElement("div", { style: st.field }, React.createElement("label", {
		style: st.label,
		htmlFor: fieldId + "-ak"
	}, t("card.apiKey")), React.createElement("input", {
		id: fieldId + "-ak",
		style: disInput,
		type: "password",
		autoComplete: "off",
	...
	}), React.createElement("p", { style: st.hint }, t("card.apiKeyHint"))), React.createElement("div", { style: st.field }, React.createElement("label", {
		style: st.label,
		htmlFor: fieldId + "-mo"
	}, t("card.model")), React.createElement("input", {
		id: fieldId + "-mo",
		style: disInput,
		type: "text",
		value: state.model,
	...
	}), React.createElement("p", { style: st.hint }, t("card.modelHint"))), React.createElement("div", { style: st.field }, React.createElement("label", {
		style: st.label,
		htmlFor: fieldId + "-bu"
	}, t("card.baseUrl")), React.createElement("input", {
		id: fieldId + "-bu",
		style: disInput,
		type: "text",
		value: state.baseURL,
	...
	}), React.createElement("p", { style: st.hint }, t("card.baseUrlHint"))), React.createElement("div", { style: st.field }, React.createElement("label", {
		style: st.label,
		htmlFor: fieldId + "-mu"
	}, t("card.maxUses")), React.createElement("input", {
		id: fieldId + "-mu",
		style: disInput,
		type: "text",
		inputMode: "numeric",
	...
	}), React.createElement("p", { style: st.hint }, t("card.maxUsesHint"))), React.createElement("div", { style: st.footer }, state.failed ? React.createElement("p", {
		style: st.failed,
		role: "status"
	}, t("saveFailed")) : null, React.createElement("button", {
		type: "button",
		style: disDis,
...
function stringField(drafts, value, field, fallback) {
...
function apply(ctx) {
	...
	const scope = ctx.settingsScope.bind({ namespace: WEB_SEARCH_ADVANCED_NS });
	const drafts = /* @__PURE__ */ new Map();
	let saving = false;
	let failed = false;
	const publishSnapshot = () => buildState(scope.getSnapshot(), drafts, saving, failed);
	const store = (0, __deepseek_ai_dsh_client_runtime_client.createSnapshotStore)(publishSnapshot());
	const publish = () => {
	...
	const saveField = async () => {
		...
		try {
			for (const [field, draft] of drafts) {
				...
				if (field === "searchProvider" || field === "baseURL" || field === "model") await scope.set(field, draft.text);
